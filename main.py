...
st.set_page_config(page_title="Global Geofencing App", layout="wide", initial_sidebar_state="collapsed")
...
def show_login():
    ...
    radius = st.slider("Select the radius (in km) to find nearby users", 1, 100, 10)  # Slider for geofence radius
